...
import kr.kro.awesometic.plankhelper.util.Constants.NOTIFICATION_CHANNEL.SERVICE_CHANNEL_NAME
    ...
    fun setNotificationForeground(context: Context, isForeground: Boolean) {
        ...
        if (isForeground) {
            ...
            plankService.startForeground(
                    ...
                    mNotificationBuilder!!.setChannelId(SERVICE_CHANNEL_NAME).build()
            )
